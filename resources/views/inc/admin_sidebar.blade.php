				...
				<div class="media">
					...
					<div class="media-body">
						...
						<div class="font-size-xs opacity-50">
							<i class="icon-user-tie font-size-sm"></i> &nbsp;{{ Auth::user()->email }}
						</div>
					</div>
		...
		<div class="card card-sidebar-mobile">
			<ul class="nav nav-sidebar" data-nav-type="accordion">
				...
				<li class="nav-item nav-item-submenu">
					<a href="#" class="nav-link {{ (Route::currentRouteName() == 'admin.users' ) ? 'active' : '' }} "><i class="icon-users"></i> <span>Users</span></a>
					<ul class="nav nav-group-sub" data-submenu-title="Users">
						<li class="nav-item"><a href="{{ route('admin.users') }}" class="nav-link {{ (Route::currentRouteName() == 'admin.users' ) ? 'active' : '' }} ">Users</a></li>
						
					</ul>
				</li>
				<li class="nav-item nav-item-submenu">
					<a href="#" class="nav-link"><i class="icon-file-css"></i> <span>Menu</span></a>
